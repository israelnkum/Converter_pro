 ...
 */
public class volume_error extends javax.swing.JFrame {

    /**
     * Creates new form volume_error
     */
    public volume_error() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        volume_Conversion uc = new volume_Conversion();
        uc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(volume_error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new volume_error().setVisible(true);
            }
        });
    }
