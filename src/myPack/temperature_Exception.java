 ...
 */
public class temperature_Exception extends javax.swing.JFrame {

    /**
     * Creates new form temperature_Exception
     */
    public temperature_Exception() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(temperature_Exception.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new temperature_Exception().setVisible(true);
            }
        });
    }
