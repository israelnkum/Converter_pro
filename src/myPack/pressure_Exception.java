 ...
 */
public class pressure_Exception extends javax.swing.JFrame {

    /**
     * Creates new form pressure_Exception
     */
    public pressure_Exception() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pressure_Exception.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pressure_Exception().setVisible(true);
            }
        });
    }
