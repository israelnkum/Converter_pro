 ...
 */
public class speed_Exception extends javax.swing.JFrame {

    /**
     * Creates new form speed_Exception
     */
    public speed_Exception() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(speed_Exception.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speed_Exception().setVisible(true);
            }
        });
    }
