 ...
 */
public class plane_angle_error extends javax.swing.JFrame {

    /**
     * Creates new form plane_angle_error
     */
    public plane_angle_error() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        plane_Angle uc = new plane_Angle();
        uc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(plane_angle_error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new plane_angle_error().setVisible(true);
            }
        });
    }
