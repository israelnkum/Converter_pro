 ...
 */
public class unit_conv_Error extends javax.swing.JFrame {

    /**
     * Creates new form unit_conv_Error
     */
    public unit_conv_Error() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unit_conv_Error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unit_conv_Error().setVisible(true);
            }
        });
    }
