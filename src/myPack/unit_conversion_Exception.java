 ...
 */
public class unit_conversion_Exception extends javax.swing.JFrame {

    /**
     * Creates new form unit_conversion_Exception
     */
    public unit_conversion_Exception() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unit_conversion_Exception.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unit_conversion_Exception().setVisible(true);
            }
        });
    }
