 ...
 */
public class mass_Exception extends javax.swing.JFrame {

    /**
     * Creates new form mass_Exception
     */
    public mass_Exception() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mass_Exception.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mass_Exception().setVisible(true);
            }
        });
    }
