 ...
 */
public class mass_conve_Error extends javax.swing.JFrame {

    /**
     * Creates new form mass_conve_Error
     */
    public mass_conve_Error() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        mass_Conversion uc = new mass_Conversion();
        uc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mass_conve_Error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mass_conve_Error().setVisible(true);
            }
        });
    }
