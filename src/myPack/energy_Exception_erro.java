 ...
 */
public class energy_Exception_erro extends javax.swing.JFrame {

    /**
     * Creates new form energy_Exception_erro
     */
    public energy_Exception_erro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(energy_Exception_erro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new energy_Exception_erro().setVisible(true);
            }
        });
    }
