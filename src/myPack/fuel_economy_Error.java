 ...
 */
public class fuel_economy_Error extends javax.swing.JFrame {

    /**
     * Creates new form fuel_economy_Error
     */
    public fuel_economy_Error() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        fuel_Economy fp = new fuel_Economy();
        fp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fuel_economy_Error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fuel_economy_Error().setVisible(true);
            }
        });
    }
